...
from ffmpeg import _run as ffmpeg1
from ffmpeg import _probe as ffmpeg2
...
import os
import sys
##关键代码，把ffmpeg的可执行文件导入进来
ffmpeg_executable_path = "C:\\ffmpeg\\bin\\ffmpeg.exe"  # 将此替换为您的 FFmpeg 可执行文件的实际路径
os.environ["PATH"] += os.pathsep + os.path.dirname(ffmpeg_executable_path)
sys.path.append(os.path.dirname(ffmpeg_executable_path))
