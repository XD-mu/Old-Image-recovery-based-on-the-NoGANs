...
namespace ColorfulSoft.DeOldify
{
    ...
    public sealed class HelpForm : Form
    {
        ...
        public HelpForm() : base()
        {
            ...
            this.__Text.Height = 100;
            this.__Text.Top = 300;
            this.__Text.Left = 10;
            this.__Text.Text = "	我们时光重塑项目致力于利用改进的NoGAN技术，为黑白老照片与视频带来全新的生命。我们的目标是让珍贵的历史影像重现光彩，传承历史文化遗产，帮助人们更好地回顾和了解过去。团队利用新进的高效的黑白影像修复与优化方案，能够智能识别照片和视频中的细节，自动修复损伤，模糊，颜色失真等问题，还原画质，提升观感。时光重塑项目为个人和企业提供专业的黑白影像修复服务，无论是家庭珍藏的老照片，还是历史影像资料，都可以借助我们的技术重现光彩";
    ...
    public sealed class MainForm : Form
    {
        ...
        public MainForm() : base()
        {
            ...
            this.__InputBox.ForeColor = SystemColors.Control;
              ...
              this.__OpenInput.Text = "导入需要处理的照片";
            ...
            this.__StartButton.Text = "转化您的图片";
